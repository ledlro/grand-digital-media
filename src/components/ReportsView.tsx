...
import { BarChart3, TrendingUp, TrendingDown, Receipt, Printer, ShieldAlert } from 'lucide-react';
    ...
    <div className="space-y-6 print:p-8 print:bg-white print:text-black">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4 print:hidden">
        ...
        <button
          ...
          className="btn py-2.5 px-4 rounded-xl font-bold bg-slate-800 hover:bg-slate-900 text-white flex items-center gap-1.5 shadow-lg shadow-slate-500/10 cursor-pointer"
        >
